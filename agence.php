            ...
            <div class="col-md-6 col-sm-12-col-xs-12 align-self-center">
                <div class="about-content p-l80 xs-p-l0">
                    <div class="ot-heading left-align">
                        <h2 class="main-heading">Nous Concernant </h2>
...
<section class="p-b120 particles-js" data-color="#fe4c1c,#00c3ff,#0160e7" data-id="a1">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="shadow-primary p-t90 p-b83 m-b110 btn-rounder bg-cover text-center m-t--140"
        ...
        <div class="row p-b40">
            <div class="col-sm-8 xs-m-b40">
                <div class="ot-heading">
                    <h6><span>Notre Équipe</span></h6>
                    <h2 class="main-heading">Rencontrez des personnes qui font des merveilles</h2>
                </div>
            </div>
            <!-- <div class="col-sm-4">
                                                            <div class="ot-button text-right xs-text-left m-t15">
                                                                <a href="#"
                                                                    class="octf-btn octf-btn-primary octf-btn-icon"><span>All
                                                                        Team <i
