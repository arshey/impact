...
<div id="content" class="site-content">
            <div class="single-page-header post-box" style="background-image: url(images/post-bg.jpg);">
                            ...
                            <article class="post-box blog-post">
                                ...
                                <div class="inner-post no-padding-top">
                                    <div class="entry-summary">
                                        ...
                                        <div class="gaps">&nbsp;</div>
                                        <p><img src="images/blog-post.png"></p>
                                        <div class="gaps">&nbsp;</div>
                                    ...
                                    <div class="author-bio">
                                        <div class="author-image">
                                            <img src="images/author-post.jpg" alt="Tom Black" class="avatar avatar-250 wp-user-avatar wp-user-avatar-250 alignnone photo">
                                        </div>
                                        <div class="author-info">
                                            ...
                                            <div class="author-socials"> 
                                                <a href="twitter.html" target="_blank" rel="nofollow" title="Twitter" class="tooltip"><i class="fab fa-twitter"></i> </a> 
                                                <a href="facebook.html" target="_blank" rel="nofollow" title="Facebook" class="tooltip"><i class="fab fa-facebook-f"></i> </a> 
                                                <a href="linkedin.html" target="_blank" rel="nofollow" title="LinkedIn" class="tooltip"><i class="fab fa-linkedin-in"></i> </a> 
                                                <a href="instagram.html" target="_blank" rel="nofollow" title="Instagram" class="tooltip"><i class="fab fa-instagram"></i> </a>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="post-box post-item">
                                                    <div class="post-inner">
                                                        <div class="entry-media">
                                                            ...
                                                            <a href="#"><img src="images/relate-post-1.jpg" alt=""></a>
                                                        </div>
                                                ...
                                                <div class="post-box post-item">
                                                    <div class="post-inner">
                                                        <div class="entry-media">
                                                            ...
                                                            <a href="#"><img src="images/relate-post-2.jpg" alt=""></a>
                                                        </div>
                                                        <div class="inner-post">
                                                            <div class="entry-header">
                                                                <div class="entry-meta">
                                ...
                                <ol class="comment-list">
                                    <li id="comment-16" class="comment-item">
                                        <article class="comment-wrap clearfix">
                                            <div class="gravatar">
                                                <img src="images/author-post.jpg" alt="Pablo Villalpando" class="">     
                                            </div>
                                    ...
                                    <li id="comment-18" class="comment-item">
                                        <article class="comment-wrap clearfix">
                                            <div class="gravatar">
                                                <img src="images/author-post.jpg" alt="Pablo Villalpando">
                                            </div>
                                            <div class="comment-content">
                                                <div class="comment-meta">
                                                    <h6 class="comment-author">Pablo Villalpando</h6>
                            ...
                            <section id="author_widget-2" class="widget onum_author-widget">
                                <div class="author-widget_wrapper text-center">
                                    <div class="author-widget_image-wrapper">
                                        <img class="author-widget_image img-circle" src="images/author.png" alt="Kate Olson">
                                    </div>
                            ...
                            <section class="widget widget_recent_news">
                                ...
                                <ul class="recent-news clearfix">
                                    ...
                                    <li class="clearfix"> 
                                        <div class="thumb">
                                            <a href="single-blog.html">
                                                <img src="images/recent-post-1.jpg" class="" alt="">
                                            </a>
                                        </div>
                                        <div class="entry-header">
                                    ...
                                    <li class="clearfix"> 
                                        <div class="thumb">
                                            <a href="single-blog.html">
                                                <img src="images/recent-post-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="entry-header">
                                    ...
                                    <li class="clearfix"> 
                                        <div class="thumb">
                                            <a href="single-blog.html">
                                                <img src="images/recent-post-3.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="entry-header">
